...
<div class="content mar_20">
    	<img src="${pageContext.request.contextPath }/statics/common/images/img3.jpg" />        
    </div>
            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              <tr height="35">
                <td style="font-size:18px;">
                	感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font color="#ff4e00">${newOrder.serialNumber }</font>
                </td>
              </tr>
              <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                	您选定的配送方式为: <font color="#ff4e00">申通快递</font>； &nbsp; &nbsp;您选定的支付方式为: <font color="#ff4e00">支付宝</font>； &nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥${newOrder.cost }</font>
                </td>
              </tr>
              <tr>
                <td style="padding:20px 0 30px 0; font-family:'宋体';">
                	 收款人信息（全称）： ${user.userName} ；地址:${nowAddress.address } ； <br />
                </td>
              </tr>
              <tr>
                <td>
                	<a href="${pageContext.request.contextPath }/load">首页</a> &nbsp; &nbsp; <a href="#">用户中心</a>
                </td>
              </tr>
            </table>        	
        </div>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath }/statics/common/js/buycar_three.js"></script>
</html>