...
<body>
<div class="top" style="background: #FF4E00">
    <div class="logo" style="margin-left: 50px"><a href="${pageContext.request.contextPath }/load"><img src="${pageContext.request.contextPath }/statics/common/images/mylogo.PNG" width="150px" height="58px"/></a></div>
    <%-- <div class="search">
    ...
    <div class="i_car" style="margin-right: 50px">
